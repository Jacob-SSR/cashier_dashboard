<?php
    ...
    $query = "SELECT o.oqueue,o.hn,CONCAT(pt.pname,pt.fname,' ',pt.lname) AS full_name,CONCAT('คุณ',pt.fname,' ',pt.lname) AS full_namecall,IFNULL(o.pt_priority,0) as 	pt_priority,
